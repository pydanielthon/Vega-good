        ...
        <div class="card-body login-card-body">
            ...
            <form method="post" action="{{ url('/login') }}">
                ...
                <div class="input-group mb-3">
                    ...
                    @error('email')
                    <span class="error invalid-feedback">     <strong>
                        @if ($message == 'validation.required')
                        Pole jest wymagane
                        @elseif ($message == 'auth.failed')
                        Weryfikacja nie powiodła się, sprawdź dane logowania
                        @elseif ($message == 'auth.throttle')
            ...
            {{-- <p class="mb-0"> --}}
                {{-- <a href="{{ route('register') }}" class="text-center"></a> --}}
            {{-- </p> --}}
        </div>
        <!-- /.login-card-body -->
    </div>
